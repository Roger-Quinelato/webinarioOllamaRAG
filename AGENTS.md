...
Siga, nesta ordem: ADR-004, ADR-003, ADR-002, ADR-001, PRD, TDD, `CONTEXT.md`, issue
ativa e este arquivo. A ADR-004 supera somente a ordem de providers da ADR-003.
A ADR-003 supera a consequência de indisponibilidade da
